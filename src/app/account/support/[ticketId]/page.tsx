  ...
  return (
    <div className="grid gap-4">
      <div className="text-sm">
        <Link className="hover:underline" href="/account/support">
          ← Back to tickets
        </Link>
      </div>
        ...
        <>
          <div className="rounded-2xl border p-6">
            ...
            <div className="mt-1 text-xs text-gray-600">
              {ticket.category} • {ticket.priority} • {ticket.status} • Updated {new Date(ticket.updatedAt).toLocaleString()}
            </div>
            {ticket.orderId ? <div className="mt-2 text-xs text-gray-600">Order ID: {ticket.orderId}</div> : null}
